...
module DE0_NANO_SOPC_mm_interconnect_0 (
	...
	wire  [91:0] cpu_debug_mem_slave_agent_rf_source_data;                                  // cpu_debug_mem_slave_agent:rf_source_data -> cpu_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [91:0] cpu_debug_mem_slave_agent_rsp_fifo_out_data;                               // cpu_debug_mem_slave_agent_rsp_fifo:out_data -> cpu_debug_mem_slave_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> cpu_debug_mem_slave_agent:cp_data
	...
	wire  [16:0] onchip_memory2_s1_agent_m0_address;                                        // onchip_memory2_s1_agent:m0_address -> onchip_memory2_s1_translator:uav_address
	...
	wire  [91:0] onchip_memory2_s1_agent_rf_source_data;                                    // onchip_memory2_s1_agent:rf_source_data -> onchip_memory2_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] onchip_memory2_s1_agent_rsp_fifo_out_data;                                 // onchip_memory2_s1_agent_rsp_fifo:out_data -> onchip_memory2_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> onchip_memory2_s1_agent:cp_data
	...
	wire  [16:0] pio_led_s1_agent_m0_address;                                               // pio_led_s1_agent:m0_address -> pio_led_s1_translator:uav_address
	...
	wire  [90:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> pio_led_s1_agent:cp_data
	...
	wire  [90:0] cpu_data_master_agent_cp_data;                                             // cpu_data_master_agent:cp_data -> router:sink_data
	...
	wire  [90:0] cpu_instruction_master_agent_cp_data;                                      // cpu_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [90:0] cpu_debug_mem_slave_agent_rp_data;                                         // cpu_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [90:0] onchip_memory2_s1_agent_rp_data;                                           // onchip_memory2_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [90:0] pio_led_s1_agent_rp_data;                                                  // pio_led_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [90:0] router_src_data;                                                           // router:src_data -> cpu_data_master_limiter:cmd_sink_data
	...
	wire  [90:0] cpu_data_master_limiter_cmd_src_data;                                      // cpu_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [90:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> cpu_data_master_limiter:rsp_sink_data
	...
	wire  [90:0] cpu_data_master_limiter_rsp_src_data;                                      // cpu_data_master_limiter:rsp_src_data -> cpu_data_master_agent:rp_data
	...
	wire  [90:0] router_001_src_data;                                                       // router_001:src_data -> cpu_instruction_master_limiter:cmd_sink_data
	...
	wire  [90:0] cpu_instruction_master_limiter_cmd_src_data;                               // cpu_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [90:0] rsp_mux_001_src_data;                                                      // rsp_mux_001:src_data -> cpu_instruction_master_limiter:rsp_sink_data
	...
	wire  [90:0] cpu_instruction_master_limiter_rsp_src_data;                               // cpu_instruction_master_limiter:rsp_src_data -> cpu_instruction_master_agent:rp_data
	...
	wire  [90:0] cmd_demux_001_src3_data;                                                   // cmd_demux_001:src3_data -> cmd_mux_003:sink1_data
	...
	wire  [90:0] rsp_demux_003_src1_data;                                                   // rsp_demux_003:src1_data -> rsp_mux_001:sink3_data
	...
	DE0_NANO_SOPC_mm_interconnect_0_router router (
	...
	DE0_NANO_SOPC_mm_interconnect_0_router router_001 (
	...
	DE0_NANO_SOPC_mm_interconnect_0_router_002 router_002 (
	...
	DE0_NANO_SOPC_mm_interconnect_0_router_002 router_003 (
	...
	DE0_NANO_SOPC_mm_interconnect_0_router_002 router_004 (
	...
	DE0_NANO_SOPC_mm_interconnect_0_router_002 router_005 (
	...
	DE0_NANO_SOPC_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_50_clk_clk),                                //        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	DE0_NANO_SOPC_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_50_clk_clk),                                       //        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	DE0_NANO_SOPC_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_50_clk_clk),                        //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_NANO_SOPC_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_50_clk_clk),                        //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_NANO_SOPC_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_50_clk_clk),                        //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_NANO_SOPC_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_50_clk_clk),                        //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_NANO_SOPC_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_50_clk_clk),                        //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_NANO_SOPC_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_50_clk_clk),                        //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_NANO_SOPC_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_50_clk_clk),                        //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_NANO_SOPC_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_50_clk_clk),                        //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_NANO_SOPC_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_50_clk_clk),                        //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE0_NANO_SOPC_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_50_clk_clk),                        //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
